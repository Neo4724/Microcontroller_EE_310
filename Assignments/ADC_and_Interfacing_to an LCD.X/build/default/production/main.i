...
void main(void)
{
    ...
    while(1)
    {
        ...
        xG = (signed int)(((signed int)xMv - (signed int)xZero) * 100 / 330);
        yG = mvToG(yMv);
        zG = mvToG(zMv);
        ...
        _delay((unsigned long)((300)*(1000000UL/4000.0)));
    }
}
...
unsigned int adcToMv(unsigned int adc)
{
    return (unsigned int)(((unsigned long)adc * 3300) / 4095);
}
...
signed int mvToG(unsigned int mv)
{
    ...
    diff = (signed int)mv - 1650;

    return (signed int)((diff * 100) / 330);
}
