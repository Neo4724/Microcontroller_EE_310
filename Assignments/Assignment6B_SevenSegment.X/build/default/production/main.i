...
;---------------------
    ...
    MOVWF PORTD, 0 ;Displays FSR value to the 7-segment




MainLoop:
    BTFSS PORTB,1 ;Checks if PORTB,1 is pressed
    GOTO CheckButton
    BTFSS PORTB,0 ;Checks if PORTB,0 is pressed
    GOTO CheckButton
...
CheckButton:
    BTFSC PORTB,1, 0 ;Checks if PORTB,1 is not pressed, goes to increment if it is
    GOTO Increment

    BTFSC PORTB,0, 0 ;Checks if PORTB,0 is not pressed, goes to decrement if it is
    GOTO Decrement
